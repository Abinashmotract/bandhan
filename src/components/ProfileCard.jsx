...
import { likeProfile, superlikeProfile, addToFavourites } from '../store/slices/interactionSlice';
  ...
  const ProfileContent = () => (
    <Card
      sx={{
        ...
        border: profile.requiresSubscription ? `2px solid ${getPlanColor('Entry')}` : '1px solid #e0e0e0'
      }}
    ...
    >
      ...
      <CardContent sx={{ flexGrow: 1, p: 2 }}>
        {/* Name and Basic Info */}
        <Box sx={{ mb: 2 }}>
          <Typography variant="h6" sx={{ color: '#000', fontWeight: 'bold', mb: 0.5 }}>
