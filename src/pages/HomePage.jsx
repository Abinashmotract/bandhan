...
const HomePage = () => {
  ...
  useEffect(() => {
    const loadFeatured = async () => {
      try {
        const res = await apiClient.get("/success-stories/featured", {
          params: { limit: 4 },
        });
        ...
        setSuccessStories(
          list.map((s) => ({
            name:
              s.title ||
              `${s.groom?.name || "Groom"} & ${s.bride?.name || "Bride"}`,
            image:
  ...
  const features = [
    {
      ...
      description:
        "Advanced algorithm to find your perfect partner based on preferences",
    },
    {
          ...
          <div className=" row gy-4 ">
            <div className="col-lg-6 col-12">
              ...
              <AnimatedSection>
                ...
                >
                  Join thousands of couples who found their soulmates through
                  our trusted matchmaking service
                </Typography>
              </AnimatedSection>
        ...
        <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
          ...
          <AnimatedSection>
            <Box sx={{ textAlign: "center", mb: 6 }}>
              ...
              >
                We provide the best platform to find your perfect life partner
              ...
              <Grid item xs={12} sm={6} md={3} key={index}>
                <AnimatedSection variant={scaleIn} threshold={0.1}>
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: "#78909c", lineHeight: 1.6 }}
                    >
                      {feature.description}
                    </Typography>
                  </Card>
