...
import VerifyPercent from "../components/verifyPercent";
  ...
  const handleProfilePictureUpload = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_BASE_URL}/auth/user/profile-picture`,
        formData,
        {
          headers: {
          ...
          <Box sx={{ p: 4, pt: 0 }}>
            ...
            <Box sx={{ mt: 2 }}>
              ...
              >
                <Typography
                  variant="h4"
                  sx={{ fontWeight: 700, color: "#51365F" }}
                >
                  {user?.name}
                </Typography>
                <Chip
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mb: 3 }}>
                ...
                >
                  <LocationOn
                    sx={{ fontSize: "18px", mr: 0.5, color: "#51365F" }}
                  />
                  {user?.location}
                </Typography>
                ...
                >
                  <Work sx={{ fontSize: "18px", mr: 0.5, color: "#51365F" }} />{" "}
                  {user?.occupation}
                </Typography>
                <Typography
                  variant="body2"
              ...
              >
                <Box sx={{ width: "100%", maxWidth: 300 }}>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{
                        color:
                          user?.profileCompletion === 100 ? "green" : "#51365F",
                        fontWeight: 600,
                      }}
                    >
                ...
                <Box sx={{ textAlign: "center" }}>
                  <Typography
                    variant="h6"
                    sx={{ color: "#51365F", fontWeight: 700 }}
                  >
                    {user?.matches || 0}%
                  </Typography>
                  <Typography variant="body2" sx={{ color: "#78909c" }}>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Box
                      sx={{
                        ml: 1,
                        background:
                          tabValue === 0 ? "#51365F" : "rgba(216, 27, 96, 0.1)",
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Box
                      sx={{
                        ml: 1,
                        background:
                          tabValue === 1 ? "#51365F" : "rgba(216, 27, 96, 0.1)",
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Box
                      sx={{
                        ml: 1,
                        background:
                          tabValue === 2 ? "#51365F" : "rgba(216, 27, 96, 0.1)",
                  ...
                  <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Box
                      sx={{
                        ml: 1,
                        background:
                          tabValue === 3 ? "#51365F" : "rgba(216, 27, 96, 0.1)",
        ...
        >
          <TabPanel value={tabValue} index={0}>
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, md: 8 }}>
                ...
                <Typography
                  variant="body1"
                  sx={{ color: "#37474f", lineHeight: 1.7, mb: 4 }}
                >
                  {user?.about}
                </Typography>
          ...
          <TabPanel value={tabValue} index={2}>
            <Typography
              variant="h6"
              gutterBottom
              sx={{ color: "#51365F", fontWeight: 600, mb: 3 }}
            >
              Family Details
            </Typography>
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <DetailItem
                  ...
                  value={
                    user?.familyDetails?.fatherOccupation || "Not specified"
                  }
                />
                <DetailItem
                  icon={<Person />}
                ...
                <DetailItem
                  ...
                  value={
                    user?.familyDetails?.motherOccupation || "Not specified"
                  }
                />
              </Grid>
              <Grid size={{ xs: 12, md: 6 }}>
          ...
          <TabPanel value={tabValue} index={3}>
            ...
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <PreferenceItem
                  title="Height"
                  value={user?.preferences?.height || "Not specified"}
                />
                <PreferenceItem
                  title="Marital Status"
                  value={user?.preferences?.maritalStatus || "Not specified"}
                />
                <PreferenceItem
                  title="Religion"
                  value={user?.preferences?.religion || "Not specified"}
                />
              </Grid>
              <Grid size={{ xs: 12, md: 6 }}>
                <PreferenceItem
                  title="Education"
                  value={user?.preferences?.education || "Not specified"}
                />
                <PreferenceItem
                  title="Profession"
                  value={user?.preferences?.profession || "Not specified"}
                />
                <PreferenceItem
                  title="Location"
                  value={user?.preferences?.location || "Not specified"}
                />
                <PreferenceItem
                  title="Diet"
                  value={user?.preferences?.diet || "Not specified"}
                />
              </Grid>
            </Grid>
          </TabPanel>
...
const PreferenceItem = ({ title, value }) => (
  <Box sx={{ mb: 3 }}>
    <Typography
      variant="subtitle2"
      sx={{ color: "#51365F", fontWeight: 600, mb: 0.5 }}
    >
      {title}
    </Typography>
