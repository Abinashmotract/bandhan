  ...
  const faqs = [
    {
      ...
      answer:
        'Click on the "Sign Up" button on the top right corner, fill in your details, verify your email, and you\'re ready to start your journey to find your perfect match.',
    },
    {
      question: "Is my personal information secure?",
      answer:
        "Yes, we take privacy seriously. All your data is encrypted and we never share your information with third parties without your consent.",
    },
    {
      question: "How does the matching algorithm work?",
      answer:
        "Our algorithm considers your preferences, interests, background, and compatibility factors to suggest the most suitable matches for you.",
    },
  ];
    ...
    <Box sx={{ py: 8 }}>
      <Container maxWidth="xl">
        ...
        <Box textAlign="center" mb={6}>
          ...
          >
            We're here to help you on your journey to find your perfect life
            partner. Reach out to us with any questions.
          </Typography>
        </Box>
          ...
          <Grid size={6}>
            <Box>
              ...
              <Typography variant="body1" sx={{ color: "#555", mb: 4 }}>
                ...
                account? Our team is here to help you every step of the way in
              ...
              <Box>
                <Typography
                  variant="h6"
                  sx={{ color: "#37474f", fontWeight: 600, mb: 2 }}
                >
                  Follow Us
                </Typography>
