...
const TermsAndConditions = () => {
  ...
  return (
    <Box sx={{ 
      minHeight: '100vh', 
      background: 'linear-gradient(135deg, rgba(216, 27, 96, 0.03) 0%, rgba(200, 162, 200, 0.05) 100%)',
      py: 4
    }}>
      <Container maxWidth="lg">
        ...
        <Card sx={{ 
          ...
          <Box sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ color: '#51365F', mb: 3, fontWeight: 700, display: 'flex', alignItems: 'center' }}>
              <Gavel sx={{ mr: 2 }} />
              1. Eligibility
            </Typography>
            <List>
          ...
          <Box sx={{ mb: 5 }}>
            <Typography variant="h5" sx={{ color: '#51365F', mb: 3, fontWeight: 700 }}>
          ...
          <Box sx={{ mb: 5 }}>
            ...
            <Typography variant="body1" sx={{ color: 'black', lineHeight: 1.7, fontStyle: 'italic' }}>
